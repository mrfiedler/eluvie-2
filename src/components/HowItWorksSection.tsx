...
const HowItWorksSection = () => {
  ...
  return <section id="how-it-works" className="section relative overflow-hidden py-24 bg-neutral-900">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => <div key={index} className="feature-card flex flex-col items-center text-center">
        ...
        <div id="eluvie-video-section" className="mt-20 mb-8 max-w-6xl mx-auto bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-xl p-10 border border-gray-700 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full from-blue-500/5 to-purple-500/5 bg-zinc-950 bg-[1a1a1a]"></div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="w-full lg:w-3/5">
                <div className="aspect-video rounded-xl overflow-hidden shadow-2xl border border-gray-600 bg-gray-800">
