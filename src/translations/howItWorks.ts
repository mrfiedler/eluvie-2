...
const howItWorksTranslations = {
  ...
  'simplified-workflows': {
    en: 'Simplified Workflows',
    'pt-BR': 'Fluxos de Trabalho Simplificados'
  },
  'simplified-workflows-desc': {
    en: 'Optimize your financial management without complex accounting knowledge',
    'pt-BR': 'Otimize sua gestão financeira sem conhecimentos contábeis complexos'
  },
  'team-collaboration': {
    en: 'Team Collaboration',
    'pt-BR': 'Colaboração em Equipe'
  },
  'client-management': {
    en: 'Client Management',
    'pt-BR': 'Gestão de Clientes'
  },
  'visual-reporting': {
    en: 'Visual Reporting',
    'pt-BR': 'Relatórios Visuais'
  },
  'budgets-invoices': {
    en: 'Budgets to Invoices',
    'pt-BR': 'Orçamentos para Faturas'
  },
...
export default howItWorksTranslations;
